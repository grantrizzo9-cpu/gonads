    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section id="why-us" className="w-full bg-background py-12 md:py-24">
          <div className="container max-w-4xl px-4 sm:px-6 mx-auto space-y-8">
            <div className="text-center">
                <h2 className="font-headline text-4xl font-bold text-primary">Why Host Pro Ai Is The Ultimate Platform for Ambitious Marketers</h2>
            </div>
            <Card>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-3xl font-bold text-primary">The Daily Payout Revolution: Your Growth</CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-3xl font-bold text-primary">We are so confident in the power of our platform that we want you to experience it firsthand with virtually no risk</CardTitle>
                </CardHeader>
                <CardContent className="text-lg space-y-4">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-3xl font-bold text-primary">The Ultimate AI Co-Pilot for Niche Dominance</CardTitle>
                </CardHeader>
                <CardContent className="text-lg space-y-4">
