...
export const strategyArticles: Article[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <h3 class="font-headline text-xl font-bold mt-6 mb-2">Step 1: The Surgical Strike (First 1-3 Referrals)</h3>
      ...
      <h3 class="font-headline text-xl font-bold mt-6 mb-2">Step 2: The AI Content Engine (Referrals 4-7)</h3>
      ...
      <h3 class="font-headline text-xl font-bold mt-6 mb-2">Step 3: The Community Flywheel (Referrals 8-10+)</h3>
  ...
  },
  {
    ...
    content: `
      ...
      <h3 class="font-headline text-xl font-bold mt-6 mb-2">NVMe vs. Legacy SSDs: A Generational Leap</h3>
  ...
  },
  {
    ...
    image: 'strategy-5',
    content: `
      <h2 class="font-headline text-2xl font-bold mb-4">Mastering Your Daily Cashflow Velocity</h2>
      ...
      <h3 class="font-headline text-xl font-bold mt-6 mb-2">The Daily Compound Growth Engine: A Case Study</h3>
...
export const pricingTiers: PricingTier[] = [
  {
    ...
    name: 'Starter',
    price: 9.95,
    description: 'For professional marketers starting their journey.',
    features: ['1 Hosted Site', 'NVMe Edge Storage', 'Full AI Content Studio', '70% Commission Rate'],
  },
  {
    id: 'bronze',
    name: 'Bronze',
    price: 29.95,
    description: 'For professional marketers expanding their portfolio.',
    features: ['5 Hosted Sites', 'NVMe Edge Storage', 'Full AI Content Studio', '70% Commission Rate'],
  },
  {
    id: 'silver',
    name: 'Silver',
    ...
    features: ['15 Hosted Sites', 'NVMe Edge Storage', 'Full AI Content Studio', '70% Commission Rate', 'Priority Support'],
  },
  {
    id: 'gold',
    name: 'Gold',
    ...
    features: ['50 Hosted Sites', 'NVMe Edge Storage', 'Full AI Content Studio', '75% Commission Rate', 'Priority Support'],
    isPopular: true,
  },
  {
    id: 'platinum',
    ...
    features: ['150 Hosted Sites', 'NVMe Edge Storage', 'Full AI Content Studio', '1-Click Niche Site Builder', '75% Commission Rate', 'Priority Support'],
  },
  {
    id: 'diamond',
    name: 'Diamond',
    price: 499.00,
    description: 'For agencies and large-scale affiliate businesses.',
